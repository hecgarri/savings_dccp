...
setwd("F:/visualizaciones/Combustibles/NuevaDescarga")
...
saveRDS(data,paste0('./datos_desestructurados_',fecha,'.rds'))
...
saveRDS(df, paste0('./datos_estructurados_',fecha,'.rds'))
