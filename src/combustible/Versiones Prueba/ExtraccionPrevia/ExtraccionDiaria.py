...
param = urllib.parse.quote_plus("DRIVER={SQL Server};SERVER=10.34.71.202;DATABASE=Estudios;UID=sa;PWD=5fQO3G8Tdk")
...
#PAra respaldo
c93_df.to_csv("C:/Users/esteban.olivares/Documents/visualizaciones/Combustibles/respaldo datos/test93"+str(hoy)+".csv",
